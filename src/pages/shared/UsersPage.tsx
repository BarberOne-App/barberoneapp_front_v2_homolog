...
const permissionOptions: Array<{
...
}> = [
  {
    ...
    description: "Permite entrar nas areas administrativas da barbearia.",
  },
  {
    key: "manageEmployees",
    label: "Gerenciar funcionarios",
    description: "Permite cadastrar, editar e remover funcionarios.",
  },
  {
    key: "manageAgendamentos",
    label: "Gerenciar agendamentos",
    description: "Permite criar, alterar e cancelar agendamentos.",
  },
  {
    key: "manageOffScheduleAppointments",
    label: "Agendamentos fora do horario",
    description: "Permite encaixes fora da grade configurada.",
  },
  {
    key: "manageBlockedDates",
    label: "Bloquear agenda",
    description: "Permite criar e remover bloqueios de agenda.",
  },
  {
    key: "manageServices",
    label: "Gerenciar servicos",
    description: "Permite administrar servicos da barbearia.",
  },
  {
    key: "addServices",
    label: "Adicionar servicos",
    description: "Permite cadastrar novos servicos.",
  },
  {
    key: "editServices",
    label: "Editar servicos",
    description: "Permite alterar servicos existentes.",
  },
  {
    key: "manageProducts",
    label: "Gerenciar produtos",
    description: "Permite administrar o estoque e catalogo.",
  },
  {
    key: "addProducts",
  ...
  },
  {
    ...
    description: "Permite alterar produtos existentes.",
  },
  {
    key: "managePayments",
    label: "Gerenciar pagamentos",
    description: "Permite acessar e administrar pagamentos.",
  },
  {
    key: "managePayroll",
    label: "Gerenciar pagamentos de equipe",
    description: "Permite controlar vales, comissoes e repasses.",
  },
  {
    key: "manageBenefits",
    label: "Gerenciar beneficios",
    description: "Permite administrar beneficios e assinaturas.",
  },
  {
    key: "manageGallery",
    label: "Gerenciar galeria",
    description: "Permite alterar imagens da barbearia.",
  },
  {
    key: "manageSettings",
    label: "Gerenciar configuracoes",
    description: "Permite alterar configuracoes gerais da barbearia.",
  },
];
...
export function UsersPage() {
  ...
  function openCreateDialog() {
    setEditingUser(null);
    setForm({ ...emptyForm, password: "123456", permissions: { ...emptyPermissions } });
    setDialogOpen(true);
  }
