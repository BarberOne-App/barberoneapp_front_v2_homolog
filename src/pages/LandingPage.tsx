...
const inputClass =
  "w-full mt-1 px-3 py-2.5 bg-neutral-900 border border-neutral-700 rounded-lg text-white text-sm placeholder-neutral-500 focus:outline-none focus:border-orange-500 disabled:opacity-50 transition-colors";
...
const cardStyles: Record<CardVariant, { wrapper: string; btn: string; badge: string; price: string }> = {
  ...
  premium: {
    wrapper: "bg-neutral-950 border-orange-500/50 ring-1 ring-orange-500/20 shadow-xl shadow-orange-500/10",
    btn: "bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-black font-bold shadow-lg shadow-orange-500/20",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm" onClick={handleClose}>
      <div className="relative bg-neutral-950 border border-neutral-800 rounded-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 border-b border-neutral-800">
          <span className="text-orange-500 text-xs font-semibold uppercase tracking-wider">Cadastro rápido</span>
        ...
        <div className="mx-6 mt-4 bg-gradient-to-r from-orange-500/10 to-orange-600/5 border border-orange-500/20 rounded-xl p-4 flex items-center justify-between gap-4">
          <div>
          ...
          <div className="text-right shrink-0">
            <div className="text-orange-400 font-black text-xl">R$ {formatPrice(plan.price)}</div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button type="submit" disabled={submitting}
              className="flex-1 py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-black font-semibold rounded-lg text-sm transition-all disabled:opacity-50">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm">
        <div className="bg-neutral-950 border border-neutral-800 rounded-2xl w-full max-w-md p-10 text-center">
          ...
          <button onClick={onSuccess}
            className="w-full py-3 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-black font-bold rounded-lg transition-all">
            Acessar o sistema
          </button>
        </div>
      </div>
      ...
      <div className="relative bg-neutral-950 border border-neutral-800 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 border-b border-neutral-800">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-orange-500 text-xs font-semibold uppercase tracking-wider">Pagamento</span>
          </div>
          <h3 className="text-xl font-bold text-white">Assinar plano {plan.name}</h3>
          <p className="text-neutral-400 text-sm mt-1">
            Cobrança de{" "}
            <strong className="text-orange-400">R$ {formatPrice(plan.price)}{getPeriodLabel(plan.interval, plan.intervalCount)}</strong>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <label className="flex items-start gap-3 cursor-pointer select-none">
            <input type="checkbox" checked={acceptedTerms} onChange={(e) => setAcceptedTerms(e.target.checked)} disabled={loading} className="mt-0.5 accent-orange-500 shrink-0" />
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button type="submit" disabled={loading || !acceptedTerms}
              className="flex-1 py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-black font-semibold rounded-lg text-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2">
              <Lock size={13} />
    ...
    <div id="topo" className="bg-black min-h-screen">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/85 backdrop-blur-md border-b border-neutral-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-28 flex items-center justify-between">
          <a href="#topo" aria-label="Barber One">
            <img src={barberOneLogo} alt="Barber One" className="h-24 w-auto object-contain" />
          </a>
          ...
          <nav className="hidden md:flex items-center gap-6" aria-label="Navegação principal">
            ...
            <button onClick={goLogin}
              className="ml-2 px-4 py-2 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-black text-sm font-semibold rounded-lg transition-all">
              Acessar Sistema
            </button>
          </nav>
          ...
          <div className="md:hidden bg-neutral-950 border-b border-neutral-800 px-4 pb-4">
            <nav className="flex flex-col gap-1 pt-2">
              ...
              <button onClick={() => { goLogin(); setMobileOpen(false); }}
                className="mt-2 w-full py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 text-black text-sm font-semibold rounded-lg">
                Acessar Sistema
              </button>
            </nav>
          </div>
      ...
      <section className="relative min-h-screen flex items-center pt-28 bg-black overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-orange-950/40 via-black to-black pointer-events-none" />
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-orange-600/5 rounded-full blur-3xl pointer-events-none" />

        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-20 grid lg:grid-cols-2 gap-14 items-center w-full">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-orange-500/10 border border-orange-500/25 rounded-full text-orange-400 text-sm mb-6">
              <Scissors size={14} />
            ...
            <p className="text-neutral-400 text-lg leading-relaxed mb-8">
              A BARBER ONE organiza agendamentos, assinaturas, comissões e relatórios para
              barbearias que querem vender mais sem perder o controle da operação.
            </p>

            <div className="flex flex-wrap gap-3 mb-8">
              <a href="#planos"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-black font-semibold rounded-lg transition-all shadow-lg shadow-orange-500/20">
                Começar agora <ArrowRight size={18} />
              </a>
              <button onClick={goLogin}
                className="px-6 py-3 border border-neutral-700 hover:border-orange-500/50 text-neutral-300 hover:text-white rounded-lg transition-colors">
                Já tenho conta
              </button>
            </div>
          ...
          <div className="flex justify-center lg:justify-end" aria-label="Identidade Barber One">
            <div className="relative w-72 h-72 sm:w-96 sm:h-96 flex items-center justify-center">
              <div className="absolute inset-0 rounded-full border border-orange-500/15 lp-o1" />
              <div className="absolute inset-8 rounded-full border border-orange-500/10 lp-o2" />
              <div className="absolute inset-16 rounded-full border border-neutral-800" />
              <div className="relative z-10 w-52 h-52 rounded-full bg-gradient-to-br from-orange-600/20 to-orange-900/10 border-2 border-orange-500/40 flex items-center justify-center overflow-hidden shadow-2xl shadow-orange-500/20">
                <img src={barberOneLogo} alt="Barber One" className="w-36 h-36 object-contain" />
              </div>
      ...
      <section className="py-24 bg-neutral-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <span className="text-orange-500 text-sm font-semibold uppercase tracking-wider">Desafios reais</span>
          ...
          <div className="grid sm:grid-cols-3 gap-5 mb-8">
            {painPoints.map(({ Icon, title, text }) => (
              <article key={title} className="bg-black border border-neutral-800 rounded-xl p-6 hover:border-orange-500/20 transition-colors">
          ...
          <div className="bg-gradient-to-r from-orange-500/5 via-orange-500/10 to-orange-500/5 border border-orange-500/15 rounded-xl p-6 text-center">
      ...
      <section id="solucoes" className="py-24 bg-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <span className="text-orange-500 text-sm font-semibold uppercase tracking-wider">Solução</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {featuresList.map(({ Icon, title, text }) => (
              <article key={title}
                className="group bg-neutral-950 hover:bg-neutral-900 border border-neutral-800 hover:border-orange-500/30 rounded-xl p-6 transition-all hover:shadow-lg hover:shadow-orange-500/5">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-lg flex items-center justify-center mb-4">
      ...
      <section id="sobre" className="py-24 bg-neutral-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <span className="text-orange-500 text-sm font-semibold uppercase tracking-wider">Por que Barber One</span>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {differentials.map(({ Icon, title, text }) => (
              <article key={title} className="text-center bg-black border border-neutral-800 rounded-xl p-8 hover:border-orange-500/20 transition-colors">
                <div className="w-14 h-14 bg-gradient-to-br from-orange-500/20 to-orange-600/10 border border-orange-500/20 rounded-full flex items-center justify-center mx-auto mb-5">
      ...
      <section id="planos" className="py-24 bg-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <span className="text-orange-500 text-sm font-semibold uppercase tracking-wider">Planos</span>
                        ...
                        <ul className="space-y-2.5 mb-8 flex-1">
                          {plan.features.map((feature) => (
                            <li key={feature} className="flex items-start gap-2 text-sm text-neutral-300">
                              <CheckCircle2 size={15} className="text-orange-500 mt-0.5 shrink-0" /> {feature}
                            </li>
                          ))}
                        </ul>
                      )}
      ...
      <section className="py-24 bg-neutral-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <span className="text-orange-500 text-sm font-semibold uppercase tracking-wider">Implantação</span>
            <h2 className="text-3xl sm:text-4xl font-black text-white mt-2">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {processSteps.map((step, i) => (
              <article key={step.number} className="relative text-center bg-black border border-neutral-800 rounded-xl p-8 hover:border-orange-500/20 transition-colors">
                {i < processSteps.length - 1 && (
                  <div className="hidden sm:block absolute top-[52px] left-[calc(100%+1px)] w-6 h-px bg-gradient-to-r from-orange-500/30 to-transparent z-10" />
                )}
                <div className="w-14 h-14 bg-gradient-to-br from-orange-600 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-5 shadow-lg shadow-orange-500/30">
      ...
      <section className="py-24 bg-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative overflow-hidden bg-gradient-to-br from-orange-600 via-orange-500 to-orange-400 rounded-2xl px-8 py-16 text-center">
            <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent pointer-events-none" />
            <div className="absolute -top-20 -right-20 w-64 h-64 bg-orange-300/20 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-orange-900/30 rounded-full blur-3xl pointer-events-none" />
            <div className="relative z-10">
              <span className="text-orange-100 text-sm font-semibold uppercase tracking-wider">
              ...
              <div className="mt-8">
                <a href="https://instagram.com/adtechsolutions_ltda" target="_blank" rel="noopener noreferrer"
                  className="text-orange-900 hover:text-black text-sm transition-colors font-medium">
