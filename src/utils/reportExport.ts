import logoPdf from "@/assets/image/logo-pdf.png";
...
async function createPdfReportBlob<TRow>(params: {
  ...
  function drawHeader() {
    ...
    if (logo) {
      ...
      textAt("BARBER ONE", marginX, pageHeight - 31, 16, true);
  ...
  function footer(pageIndex: number, totalPages: number) {
    ...
    footerContent += `BT /F1 8 Tf 1 0 0 1 ${marginX} 26 Tm (Gerado automaticamente pelo sistema Barber One) Tj ET\n`;
